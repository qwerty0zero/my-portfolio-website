...
const _sfc_main$a = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><div id="my_works" style="${ssrRenderStyle(!isMobile.value ? null : { display: "none" })}" class="sticky_parent" data-v-6d2e2e74><section class="sticky" data-v-6d2e2e74><div class="scroll_section" data-v-6d2e2e74><div class="panel about-panel" data-v-6d2e2e74><aside data-v-6d2e2e74>`);
      ...
      _push(`<div class="links_block" data-v-6d2e2e74><a href="" data-v-6d2e2e74><span data-v-6d2e2e74>GitHub</span></a><a href="" data-v-6d2e2e74><span data-v-6d2e2e74>LinkedIn</span></a></div></aside></div><!--[-->`);
      ssrRenderList(projectInfo.value, (project, index) => {
        _push(`<div class="panel project-panel" data-v-6d2e2e74>`);
      ...
      _push(`<!--]--></div></section></div><section id="my_works" style="${ssrRenderStyle(isMobile.value ? null : { display: "none" })}" class="vertical-scroll-section" data-v-6d2e2e74><div class="mobile-panel about-panel" data-v-6d2e2e74>`);
      _push(ssrRenderComponent(SectionDescription, {
        class: "description",
        title: "ABOUT ME",
        description: "I'm Ihor — a frontend developer with a passion for building sleek, responsive interfaces using Vue. I also create Telegram and trading bots with Python, blending clean code with smart automation. With a strong eye for design, I deliver both functionality and visual polish across web projects."
      }, null, _parent));
      _push(`<div class="links_block" data-v-6d2e2e74><a href="" data-v-6d2e2e74><span data-v-6d2e2e74>GitHub</span></a><a href="" data-v-6d2e2e74><span data-v-6d2e2e74>LinkedIn</span></a></div></div><!--[-->`);
      ssrRenderList(projectInfo.value, (project, index) => {
        _push(`<div class="mobile-panel project-panel" data-v-6d2e2e74>`);
        _push(ssrRenderComponent(ProjectItem, {
          class: "mobile",
          project,
          index,
...
const SectionsFolder = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$a, [["__scopeId", "data-v-6d2e2e74"]]), { __name: "SectionsFolder" });
const _sfc_main$9 = {
  __name: "SectionBase",
  __ssrInlineRender: true,
  props: {
...
//# sourceMappingURL=index-BMz_fRc3.mjs.map
